...
export function HistoryBook() {
  ...
  return (
    <SceneShell scene="history">
      <AppFrame className="info-page info-page-history" title="月度史册" eyebrow="已发生之事 · 天下余波" back={<ActionSealButton priority="ghost" onClick={() => navigate('situation')}><ArrowLeft/> 返回局势枢纽</ActionSealButton>}>
