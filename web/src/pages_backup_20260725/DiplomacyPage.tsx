...
export function DiplomacyPage() {
  ...
  return (
    <SceneShell scene="diplomacy">
      <AppFrame className="info-page" title="外交档案" eyebrow="使臣 · 会盟 · 天下反应" back={<ActionSealButton priority="ghost" onClick={() => navigate('situation')}><ArrowLeft/> 返回局势枢纽</ActionSealButton>} actions={<ActionSealButton priority="primary" onClick={() => setShowDraft(true)}><BookOpen/> 拟外交方略</ActionSealButton>}>
