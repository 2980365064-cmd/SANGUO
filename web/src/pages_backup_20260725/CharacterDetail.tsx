...
export function CharacterDetail() {
  ...
  return (
    <SceneShell scene="character">
      <AppFrame className="info-page" title="人物档案" eyebrow="人物关系 · 心迹与反应" back={<ActionSealButton priority="ghost" onClick={() => navigate('situation')}><ArrowLeft/> 返回局势枢纽</ActionSealButton>} actions={<div className="filter-tabs">
