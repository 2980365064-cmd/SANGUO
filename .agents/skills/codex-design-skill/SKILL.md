...
description: Create distinctive, production-grade frontend interfaces directly in code with a strong visual point of view. Use when Codex is asked to design or redesign a page, screen, flow, or component; improve UI quality; or ship polished frontend experiences that must feel intentional and non-generic. In SANGUO, follow the project UI Design System priority and do not override its Art Director rules.
---

# UI Design

## SANGUO integration override

For SANGUO UI work, first obey the project-level five-layer UI Design System: `sanguo-ui-art-director` outranks this skill and `frontend-design`; keep the existing frontend framework instead of defaulting to Next.js; do not require 21st.dev or screenshot-capture capability before proceeding. Use external inspiration only when explicitly useful and permitted, and never let it displace the SANGUO historical-archive direction.
